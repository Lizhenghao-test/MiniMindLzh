...
st.set_page_config(page_title="MiniMind2", initial_sidebar_state="collapsed")
...
MODEL_PATHS = {
    ...
    "MiniMind2-V1 (0.1B)": ["../minimind-v1", "MiniMind2-V1"],
    "MiniMind2-V1-MoE (0.1B)": ["../minimind-v1-moe", "MiniMind2-V1-MoE"],
    "MiniMind2-V1-Small (0.02B)": ["../minimind-v1-small", "MiniMind2-V1-Small"],
}
...
def main():
    ...
    # 处理新的输入或重新生成
    prompt = st.chat_input(key="input", placeholder="给 MiniMind2 发送消息")
