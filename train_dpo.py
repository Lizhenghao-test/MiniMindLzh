...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind2 RLHF")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind2-RLHF-SFT")
    ...
    args.wandb_run_name = f"MiniMind2-Full-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
