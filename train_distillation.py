...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind2 Full SFT")
    ...
    args.wandb_run_name = f"MiniMind2-Dist-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
