...
def main():
    parser = argparse.ArgumentParser(description="Chat with MiniMind2")
    ...
    parser.add_argument('--model_mode', default=2, type=int, help="0: 预训练模型，1: SFT-Chat模型，2: RLHF-Chat模型，3: Reason模型")
